...
const ButtonMenu = () => {
    ...
    return (
        <section onBlur={ handleBlur } className="fixed bottom-0">
            ...
            <button onClick={ handleClick } className={`bg-blue-800 rounded-full z-20 w-20 h-20 m-7 flex justify-center items-center text-white shadow-md transition-transform ${isActive && "scale-90"}`}>
